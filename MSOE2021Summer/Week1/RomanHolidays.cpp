...
int main() {
    ...
    sort(numerals, numerals + NUMS);
//    for (int i = 0; i < NUMS;++i) {
//        cout << i + 1 << " " << -NUMS + i << " " << numerals[i] << endl;
//    }
...
//    cout << MLoc << endl;
    ...
    for (int i = 0; i < n; ++i) {
        ...
        if (find(numerals, numerals + 1000, roman.first) <=
            ...
            nums[i] = -1 * roman.second * (1000 - MLoc) + -1 * (distance(find(numerals, numerals + 1000, roman.first), numerals + 1000));
