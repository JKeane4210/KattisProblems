...
class segment_tree {
public:
    pair<E, E> * data; // {range value, value to be added to range}
    int size;
    ...
    // adds x to a range [a, b] (inclusive)
    ...
    // gets the sum of a range [a, b] (inclusive)
    E sum(int a, int b) {
...
int main() {
    ...
    segment_tree<int> seg_tree(8);
    seg_tree.add_range(1, 5, 2);
    seg_tree.dfs();
